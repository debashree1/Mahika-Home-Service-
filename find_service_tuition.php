                ...
                <div class="card-body">
                    <ul class="tab-list">
                        ...
                        <li class="tab-list__item active">
                            <a class="tab-list__link" href="#tab4" data-toggle="tab">Tuition</a>
                        </li>
                        <li class="tab-list__item">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab4">
                            <form method="POST" action="find_service2_tuition.php">
                                <div class="row row-space">
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <label class="label">Select Tuition:</label>
                                            <i class="zmdi zmdi-assignment input-group-symbol"></i>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <i class="zmdi zmdi-stack-overflow input-group-symbol"></i>
                                            <div class="rs-select2 js-select-simple select--no-search">
                                                <select name="level" required="required" class="form-control">
                                                    ...
                                                    <option value="Class X">Class X</option>t
                                                </select>
                                                <div class="select-dropdown"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="row row-space">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <label class="label">How Many Months</label>
                                            <input required class="input--style-1" style="text-transform: lowercase" placeholder="eg:  1 , 2 etc" name="months" type="number">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="rs-select2 js-select-simple select--no-search">
                                                <select name="duration" required="required" class="form-control">
                                                    <option value="" selected disabled>--Select--</option>
                                                    <option value="1">1 Hour /day -- No Extra Charge</option>
                                                    <option value="1.5">1.5 Hours /day -- With Extra Charge</option>
                                                    <option value="2">2 Hours /day -- With Extra Charge</option>
                                                </select>
                                                <div class="select-dropdown"></div>
                                            </div>
                                        </div>
