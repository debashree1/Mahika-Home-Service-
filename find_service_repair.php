                ...
                <div class="card-body">
                    <ul class="tab-list">
                        ...
                        <li class="tab-list__item active">
                            <a class="tab-list__link" href="#tab2" data-toggle="tab">Repair</a>
                        </li>
                        <li class="tab-list__item">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab2">
                            <form method="POST" action="find_service2_repair.php">
                                <div class="input-group">
                                    <label class="label">Select Repair Service:</label>
                                    <i class="zmdi zmdi-battery-unknown input-group-symbol"></i>
