...
else
{
    ...
    if ($area!=null)
    {
        ...
        $charge=$rate*$days;
        $transport=$transport_charge*$days;
        $extra=$extra_charge*$days;
        $worker_cost=$charge+$transport+$extra;
        $web_cost=($worker_cost*5)/100;
        ...
        <section class="features" id="features" style="background: url(img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
            <form action="find_service2_maid.php" method="post">
                    ...
                    <div class="col-sm-12 col-md-12 my-auto">
                        <div class="container-fluid">
                                    ...
                                    <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius: 10px;background: rgba(0,0,0,.6);">
                                        <div class="loginBox2">
                                            ...
                                            <form action="find_service.php" method="post">
                                                ...
                                                <p style="color: #f1b0b7;">Date from : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo $from; ?></b></p>
                                                <p style="color: #f1b0b7;">No. of days : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo $days; ?></b></p>
                                                <p style="color: #f1b0b7;">Work start time : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo $time; ?></b></p>
                                                <p style="color: #f1b0b7;">Duration : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo $duration." hours"; ?></b></p>
                                                ...
                                                <br>
                                                <input class="btn" style="background-color: deeppink;color: white" type="submit" name="" value="Edit requirements">
                                            </form>
                                        </div>
                                    </div><br>
                                </div>
                                        ...
                                        <div class="loginBox2">
                                            ...
                                            <form action="find_service.php" method="post">
                                                ...
                                                else
                                                {
                                                    ...
                                                    <p style="color: #f1b0b7;">Phone No : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "+91 ".$w_phone; ?></b></p>
                                                    <p style="color: #f1b0b7;">Email : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo $w_email; ?></b></p>
                                                    <p style="color: #f1b0b7;">Address : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo $w_address." , ".$sub ." , ".$w_pin." , ".$city; ?></b></p>
                                                ...
                                                <br>
                                                <p style="color: red;">Note : <b style="color: yellow;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'">Talk to the maid on the phone or meet personally. Book the maid first and pay only after the maid joins.</b></p>
                                ...
                                <div class="col-md-4">
                                    <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius:10px;background: rgba(0,0,0,.6);">
                                        <div class="loginBox2">
                                            ...
                                            <form action="confirm_maid.php" method="post">
                                                <p style="color: #f1b0b7;">Mode : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo $payment." "; ?></b><a href="user_card.php" class="small" style="color: blue;border-bottom: 1px solid blue">change</a></p>
                                                <p style="color: #f1b0b7;;border-bottom: 2px solid deeppink">Rate : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$rate." / day"; ?></b></p>
                                                <p style="color: #f1b0b7;">Charge : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$rate." * ".$days." = Rs. ".$charge; ?></b></p>
                                                <p style="color: #f1b0b7;">Transport : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$transport_charge." * ".$days." = Rs. ".$transport; ?></b></p>
                                                <p style="color: #f1b0b7;">Extra time : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$extra_charge." * ".$days." = Rs. ".$extra; ?></b></p>
                            ...
                            <center style="color: lightgrey"><br>
                                ...
                                <h3>Again, max 3hour work does not cost you extra charge. For extra time work, Rs.50/hour will be charged.</h3>
                            </center>
        </section>
        <!-- Jquery JS-->
