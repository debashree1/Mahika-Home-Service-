...
else
{
    ...
    if ($area!=null)
    {
        ...
        <section class="features" id="features" style="background: url(img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
            <form action="find_service2_tuition.php" method="post">
                <input type="hidden" name="username" value="<?php echo $username; ?>">
                <input type="hidden" name="category" value="Tuition">
                    ...
                    <div class="col-sm-12 col-md-12 my-auto">
                        <div class="container-fluid">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius: 10px;background: rgba(0,0,0,.6);">
                                        <div class="loginBox2">
                                            ...
                                            <form action="find_service_tuition.php" method="post">
                                    ...
                                    <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius: 10px;background: rgba(0,0,0,.6);">
                                        <div class="loginBox2">
                                            ...
                                            <form action="find_service.php" method="post">
                                                ...
                                                <br>
                                                <p style="color: red;">Note : <b style="color: yellow;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'">Talk to the tutor on the phone or meet personally. Book the tutor and pay only after the tutor joins.</b></p>
                                ...
                                <div class="col-md-4">
                                    <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius:10px;background: rgba(0,0,0,.6);">
                                        <div class="loginBox2">
                                            ...
                                            <form action="confirm_tuition.php" method="post">
                                                ...
                                                <p style="color: #f1b0b7;;border-bottom: 2px solid deeppink">Rate : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$rate." / month"; ?></b></p>
                                                <p style="color: #f1b0b7;">Charge : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$rate." * ".$months." = Rs. ".$charge; ?></b></p>
                                                ...
                                                <p style="color: #f1b0b7;">Extra : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$extra_charge." * ".$months." * 30 = Rs. ".$extra; ?></b></p>
                            ...
                            <center style="color: lightgrey"><br>
                                <h3>Note: If tutor does not belong to your area, Rs.450/month will be charged as transportation fee.</h3>
