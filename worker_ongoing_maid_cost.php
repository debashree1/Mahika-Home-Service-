        ...
        if ($booking_request=="Ongoing")
        {
            if ($service_area!=null)
            {
                ...
                <section class="features" id="features" style="background: url(img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                    <form action="worker_ongoing.php" method="post">
                                            ...
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius:10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    <center><h3 class="text-white">Payment Info</h3><br></center>
                                                        ...
                                                        {
                                                            ?>
                                                            <form action="worker_maid_finish_update.php" method="post">
                                                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                                                            <input type="hidden" name="booking_request" value="Ongoing">
                                                            <input class="btn" style="background-color: green;color: white" type="submit" name="" value="Finished work?">
                                                            </form>
                                                            <?php
                                                        }
                                                        else
                                                        {
                                                            ?>
                                                            <form action="worker_maid_verify.php" method="post">
                                                                <input type="hidden" name="id" value="<?php echo $id; ?>">
                                                                <input type="hidden" name="booking_request" value="Ongoing">
                                                                <input class="btn" style="background-color: green;color: white" type="submit" name="" value="Verify code?">
                                                            </form>
                                                            <?php
                                                        }
                                                        ?>
