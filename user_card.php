...
if(!isset($_SESSION["username"]))
{
    ...
    @$query="SELECT pay_method,card_no FROM user_details where username='$username'";
        ...
        while ($row=mysqli_fetch_array($result))
        {
            ...
            if ($dbpay_method=='COD')
            {
                ...
                <section class="features tb bb" id="features">
                    ...
                    <h1 class="mb-4 text-light">Payment Details</h1><br>
                    ...
                    <div class="container1">
                        <form action="user_card_edit.php" method="post">
