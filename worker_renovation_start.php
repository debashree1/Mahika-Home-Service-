...
if(!isset($_SESSION["username"]))
{
    ...
    @$query="select booking_request,code_verified from renovation_bookings where id='$id'";
    ...
    if ($id!=null)
    {
        if ($result)
        {
            ...
            {
                @$q="UPDATE renovation_bookings SET booking_request='Ongoing',code='$code' where id='$id'";
