...
if(!isset($_SESSION["username"]))
{
    ...
    @$q="SELECT * FROM renovation_bookings where customer_username='$username' and booking_request='Pending' and from_date >= '$today' order by from_date asc";
    ...
    if($res)
    {
        ...
        if ($rowcount!=0)
        {
            ...
            <section class="features tb bb" id="features" >
                ...
                <br><br>
                <center><h2 style="font-size: 35px;" class="mb-4 text-light">Your upcoming renovation service are...</h2>
                </center>
...

                        {
                            ...
                            while ($row=mysqli_fetch_array($result))
                            {
                                ...
                                <tr class="row" style="background-color: lavender;color: #117a8b">
                                    ...
                                    <form action="upcoming_renovation_cost.php" method="post">
                ...
                <center>
                    ...
                    <h3 class="btn btn-light"><a href="user_renovation_ongoing.php" style="color: black">To ongoing renovation service >></a></h3>
                </center>
                <br><br><br>
            </section>
            <!-- Jquery JS-->
        ...
        else
        {
            ...
            <section class="features" id="features" style="background: url(img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                ...
                <div class="container">
                    <br><br><br><br><br>
                    <center><h2 style="color: white;font-size: 40px">Dear customer, you don't have any upcoming renovation service.</h2>
                        <br>
