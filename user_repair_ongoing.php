...
if(!isset($_SESSION["username"]))
{
    ...
    @$q="SELECT * FROM repair_bookings where customer_username='$username' and booking_request='Ongoing' order by from_date asc";
    ...
    if($res)
    {
        ...
        if ($rowcount!=0)
        {
            ...
            <section class="features tb bb" id="features" >
                ...
                <br><br>
                <center><h2 style="font-size: 35px;" class="mb-4 text-light">Your ongoing repair service are...</h2>
                </center>
...

                        {
                            ...
                            while ($row=mysqli_fetch_array($result))
                            {
                                ...
                                <tr class="row" style="background-color: lavender;color: #117a8b">
                                    ...
                                    <form action="ongoing_repair_cost.php" method="post">
        ...
        else
        {
            ...
            <section class="features" id="features" style="background: url(img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                ...
                <div class="container">
                    <br><br><br><br><br>
                    <center><h2 style="color: white;font-size: 40px">Dear customer, you don't have any ongoing repair service.</h2>
                        <br>
