...
else
{
    ...
    $a=mysqli_connect("localhost","root","","Mahika") or die("unable to connect");
     if($id!=null)
    {
        @$q="update beauty_bookings set complain_registered='Yes',feedback='$complain' where id='$id'";
        @$r = mysqli_query($a, $q);
        if ($r)
        {
            ?>
            ...
            <section class="features tb bb" id="features" >
                <form action="user_beauty_ongoing.php" method="post">
    ...
    {
        header("Location:user_beauty_ongoing.php");
    }
}
?>
