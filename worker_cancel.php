...
else
{
    ...
    if($res)
    {
        ...
        if ($dbcategory=='Maid')
        {
            $query="SELECT * FROM maid_bookings where worker_username='$username' and booking_request in ('Cancelled by user','Cancelled due to insufficient balance','Cancelled by worker') order by from_date";
            ...
            if ($result)
            {
                ...
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <br><br>
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Your cancelled maid work are...</h2>
                        </center>
...

                                {
                                    ...
                                    while ($row=mysqli_fetch_array($result1))
                                    {
                                        ...
                                        <tr class="row" style="background-color: lavender;color: #117a8b">
                                            ...
                                            <form action="worker_cancelled_maid_cost.php" method="post">
                ...
                else
                {
                    ...
                    <section class="features" id="features" style="background: url(img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                        ...
                        <div class="container">
                            <br><br><br><br><br>
                            <center><h2 style="color: white;font-size: 40px">Dear Mahika Associate, you don't have any cancelled work.</h2>
                                <br>
                                <br><br>
        ...
        {
            $query="SELECT * FROM repair_bookings where worker_username='$username' and booking_request in ('Cancelled by user','Cancelled due to insufficient balance','Cancelled by worker') order by from_date";
            $result=mysqli_query($a,$query);
            if ($result)
            {
                $rowcount=mysqli_num_rows($result);
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <br><br>
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Your cancelled repair work are...</h2>
                        </center>
                        <table class="container table table-striped">
                            <thead>
                            <tr class="bg-warning row">
...

                                {
                                    ...
                                    while ($row=mysqli_fetch_array($result1))
                                    {
                                        ...
                                        <tr class="row" style="background-color: lavender;color: #117a8b">
                                            ...
                                            <td class="col-sm-1" style="text-align: center"><?php echo $dbtime; ?></td>
                                            <td class="col-sm-2" style="text-align: center"><?php echo "Rs. ".$dbtotal; ?></td>
                                            <form action="worker_cancelled_repair_cost.php" method="post">
                                                <input type="hidden" name="service" value="<?php echo $dbservice; ?>">
                                                <input type="hidden" name="booking_request" value="<?php echo $dbbooking_request; ?>">
                                                <input type="hidden" name="id" value="<?php echo $dbid; ?>">
                                                <input type="hidden" name="u_username" value="<?php echo $dbu_username; ?>">
        ...
        {
            $query="SELECT * FROM beauty_bookings where worker_username='$username' and booking_request in ('Cancelled by user','Cancelled due to insufficient balance','Cancelled by worker') order by from_date";
            $result=mysqli_query($a,$query);
            if ($result)
            {
                $rowcount=mysqli_num_rows($result);
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <br><br>
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Your cancelled beauty work are...</h2>
                        </center>
                        <table class="container table table-striped">
                            <thead>
                            <tr class="bg-warning row">
...

                                {
                                    ...
                                    while ($row=mysqli_fetch_array($result1))
                                    {
                                        ...
                                        <tr class="row" style="background-color: lavender;color: #117a8b">
                                            ...
                                            <td class="col-sm-1" style="text-align: center"><?php echo $dbtime; ?></td>
                                            <td class="col-sm-2" style="text-align: center"><?php echo "Rs. ".$dbtotal; ?></td>
                                            <form action="worker_cancelled_beauty_cost.php" method="post">
                                                <input type="hidden" name="service" value="<?php echo $dbservice; ?>">
                                                <input type="hidden" name="booking_request" value="<?php echo $dbbooking_request; ?>">
                                                <input type="hidden" name="id" value="<?php echo $dbid; ?>">
                                                <input type="hidden" name="u_username" value="<?php echo $dbu_username; ?>">
        ...
        {
            $query="SELECT * FROM photography_bookings where worker_username='$username' and booking_request in ('Cancelled by user','Cancelled due to insufficient balance','Cancelled by worker') order by from_date";
            $result=mysqli_query($a,$query);
            if ($result)
            {
                $rowcount=mysqli_num_rows($result);
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <br><br>
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Your cancelled photography work are...</h2>
                        </center>
                        <table class="container table table-striped">
                            <thead>
                            <tr class="bg-warning row">
...

                                {
                                    ...
                                    while ($row=mysqli_fetch_array($result1))
                                    {
                                        ...
                                        <tr class="row" style="background-color: lavender;color: #117a8b">
                                            ...
                                            <td class="col-sm-1" style="text-align: center"><?php echo $dbtime; ?></td>
                                            <td class="col-sm-2" style="text-align: center"><?php echo "Rs. ".$dbtotal; ?></td>
                                            <form action="worker_cancelled_photo_cost.php" method="post">
                                                <input type="hidden" name="service" value="<?php echo $dbservice; ?>">
                                                <input type="hidden" name="booking_request" value="<?php echo $dbbooking_request; ?>">
                                                <input type="hidden" name="id" value="<?php echo $dbid; ?>">
                                                <input type="hidden" name="u_username" value="<?php echo $dbu_username; ?>">
        ...
        {
            $query="SELECT * FROM movers_bookings where worker_username='$username' and booking_request in ('Cancelled by user','Cancelled due to insufficient balance','Cancelled by worker') order by from_date";
            $result=mysqli_query($a,$query);
            if ($result)
            {
                $rowcount=mysqli_num_rows($result);
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <br><br>
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Your cancelled packers & movers work are...</h2>
                        </center>
                        <table class="container table table-striped">
                            <thead>
                            <tr class="bg-warning row">
...

                                {
                                    ...
                                    while ($row=mysqli_fetch_array($result1))
                                    {
                                        ...
                                        <tr class="row" style="background-color: lavender;color: #117a8b">
                                            ...
                                            <td class="col-sm-1" style="text-align: center"><?php echo $dbtime; ?></td>
                                            <td class="col-sm-2" style="text-align: center"><?php echo "Rs. ".$dbtotal; ?></td>
                                            <form action="worker_cancelled_movers_cost.php" method="post">
                                                <input type="hidden" name="service" value="<?php echo $dbservice; ?>">
                                                <input type="hidden" name="booking_request" value="<?php echo $dbbooking_request; ?>">
                                                <input type="hidden" name="id" value="<?php echo $dbid; ?>">
                                                <input type="hidden" name="u_username" value="<?php echo $dbu_username; ?>">
        ...
        {
            $query="SELECT * FROM tuition_bookings where worker_username='$username' and booking_request in ('Cancelled by user','Cancelled due to insufficient balance','Cancelled by worker') order by from_date";
            $result=mysqli_query($a,$query);
            if ($result)
            {
                $rowcount=mysqli_num_rows($result);
                if ($rowcount != 0)
                {
                    ...
                    <section class="features tb bb" id="features">
                        ...
                        <br><br>
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Your cancelled tuition work
                                are...</h2>
                        </center>
                        <table class="container table table-striped">
                            <thead>
                                ...
                                if ($result1) {
                                    ...
                                    while ($row = mysqli_fetch_array($result1)) {
                                        ...
                                        <tr class="row" style="background-color: lavender;color: #117a8b">
                                            ...
                                            <form action="worker_cancelled_tuition_cost.php" method="post">
        ...
        {
            $query="SELECT * FROM renovation_bookings where worker_username='$username' and booking_request in ('Cancelled by user','Cancelled due to insufficient balance','Cancelled by worker') order by from_date";
            $result=mysqli_query($a,$query);
            if ($result)
            {
                $rowcount=mysqli_num_rows($result);
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <br><br>
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Your cancelled renovation work are...</h2>
                        </center>
                        <table class="container table table-striped">
                            <thead>
                            <tr class="bg-warning row">
...

                                {
                                    ...
                                    while ($row=mysqli_fetch_array($result1))
                                    {
                                        ...
                                        <tr class="row" style="background-color: lavender;color: #117a8b">
                                            ...
                                            <td class="col-sm-1" style="text-align: center"><?php echo $dbtime; ?></td>
                                            <td class="col-sm-2" style="text-align: center"><?php echo "Rs. ".$dbtotal; ?></td>
                                            <form action="worker_cancelled_renovation_cost.php" method="post">
                                                <input type="hidden" name="service" value="<?php echo $dbservice; ?>">
                                                <input type="hidden" name="booking_request" value="<?php echo $dbbooking_request; ?>">
                                                <input type="hidden" name="id" value="<?php echo $dbid; ?>">
                                                <input type="hidden" name="u_username" value="<?php echo $dbu_username; ?>">
