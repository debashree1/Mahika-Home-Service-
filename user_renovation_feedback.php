...
else
{
    ...
    if($id!=null)
    {
        ...
        <section class="features tb bb" id="features" >
            <form action="user_renovation_finished.php" method="post">
                <input type="submit" class="cont_button2 btn-dark" value="<< Back">
            </form>
            <br>
            <center><h3 style="font-size: 40px" class="text-light"><u>Pick a feedback from the following</u></h3></center><br><br>
            <div class="container">
                <form action="feedback_renovation_update.php" method="post">
                    <div class="row">
                        <div class="col-md-3"></div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <select name="complain" required="required" class="form-control">
                                    <option value="" selected disabled>--Select a feedback--</option>
                                    <option value="The worker solves the problem within time.">The worker solves the problem within time.</option>
                                    <option value="I will recommend this app to others.">I will recommend this app to others.</option>
                                    ...
                                    <option value="The worker needs to improve communication skills.">The worker needs to improve communication skills.</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3"></div>
    ...
    {
        header("Location:user_renovation_finished.php");
    }
}
?>
