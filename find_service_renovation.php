                ...
                <div class="card-body">
                    <ul class="tab-list">
                        ...
                        <li class="tab-list__item active">
                            <a class="tab-list__link" href="#tab7" data-toggle="tab">Renovation</a>
                        </li>
                        <li class="tab-list__item">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab7">
                            <form method="POST" action="find_service2_renovation.php">
                                <div class="row row-space">
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <label class="label">Select Renovation Service:</label>
                                            <i class="zmdi zmdi-format-paint input-group-symbol"></i>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <label class="label">Select Your House:</label>
                                            <i class="zmdi zmdi-home input-group-symbol"></i>
                                            <div class="rs-select2 js-select-simple select--no-search">
                                                <select name="house" required="required" class="form-control">
                                                    <option value="" selected disabled>--Select--</option>
