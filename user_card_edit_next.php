...
if(!isset($_SESSION["username"]))
{
    ...
    $pay_method=$_REQUEST['payment'];
    if ($pay_method=='COD')
    {
        $a=mysqli_connect("localhost","root","","Mahika") or die("unable to connect");
        @$q="UPDATE user_details SET pay_method='$pay_method',card_no='' where username='$username'";
    ...
    else
    {
        ...
        <section class="features tb bb" id="features" >
            ...
            <br>
            <center><h3 style="font-size: 40px" class="text-light"><u>Credit Card Details</u></h3></center><br>
            <center>
                <div class="col-md-9">
