        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger hvr-glow" href="#">User-Profile</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="features" id="features" style="background: url('img/A.jpg') center center/cover no-repeat;">
        <div class="container">
            <div style="text-align: center;margin-top: 60px;">
                <h1 class="mb-5 text-light" style="font-size: 50px;">My Profile</h1>
            </div>
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                ...
                                <div class="feature-item" style="border-radius: 10px;background:-webkit-gradient(linear, left top, right top, from(#1da1f2), to(#dee2e6))">
                                    <a href="user_personal.php">
                                        <i><img class="hvr-bounce-in" src="img/rtrt.png"></i>
                                        <br>
                                        <h3 style="color: #3b5998;margin-top: 8px;">Personal Details</h3>
                                    </a>
                            ...
                            <div class="col-sm-5">
                                <div class="feature-item" style="border-radius:10px;background:-webkit-gradient(linear, left top, right top, from(#1da1f2), to(#dee2e6))">
                                    <a href="user_card.php">
                                        <i><img class="hvr-bounce-in" src="img/mini_yyy.png"></i>
                                        <br>
                                        <h3 style="color: #3b5998;margin-top: 8px;">Payment Details</h3>
