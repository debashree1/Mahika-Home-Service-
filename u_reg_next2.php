    ...
    if ($_SESSION["username"]==true)
    {
        ...
        if($result)
        {
                ...
                if ($payment=='Card Payment')
            {
                ...
                $query = "insert into user_details(name , email,   city  ,  area   , address, pin, username  ,  phone ,  password  ,  question ,   answer , gender , pay_method) values('$name','$email','$city','$area','$address','$pin','$username','$phone','$password','$question','$answer','$gender','$payment')";
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-info" id="mainNav">
                        <div class="container">
                            ...
                            <a class="navbar-brand " href="#page-top">
                                <h2>
                                    <small style="font-family: Arial;border-bottom: 2px solid gainsboro">Service Expert
                                    </small>
                                </h2>
                            </a>
