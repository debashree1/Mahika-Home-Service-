...
if(!isset($_SESSION["username"]))
{
    ...
    @$query="select booking_request,pay_method,total from renovation_bookings where id='$id'";
    ...
    if ($id!=null)
    {
        if ($result)
        {
            ...
            {
                @$q="UPDATE renovation_bookings SET booking_request='Finished',service_finish_time='$date' where id='$id'";
                        ...
                        <div class="col-sm-12 col-md-12 my-auto">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <form action="cash_renovation_received.php" method="post">
