...
if(!isset($_SESSION["username"]))
{
    ...
    @$query="select booking_request,code_verified from photography_bookings where id='$id'";
    ...
    if ($id!=null)
    {
        if ($result)
        {
            ...
            {
                @$q="UPDATE photography_bookings SET booking_request='Ongoing',code='$code' where id='$id'";
