        ...
        if($res)
        {
            ...
            <section class="features tb bb" id="features" >
                ...
                else
                {
                    ...
                    <br><br><br><br><br><br>
                    <div><br>
                        <h1 style="font-size: 40px" class="mb-4 text-light">Oops.. No <?php echo $service; ?> professional found within your 5km radius also</h1>
                        <center><h3 class="mb-4 text-light">Sorry for the inconvenience... We will surely increase man power in your area soon.</h3>
                            <form action="find_service2_maid.php" method="post">
                                <input type="hidden" name="username" value="<?php echo $username; ?>">
                                <input type="hidden" name="category" value="<?php echo $category; ?>">
                                <input type="hidden" name="service" value="<?php echo $service; ?>">
