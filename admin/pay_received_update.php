...
if(!isset($_SESSION["username"]))
{
    ...
    if ($category!=null)
    {
        if ($category=='Beauty')
        {
            @$q="update beauty_bookings set website_pay_received='Yes' where id='$id'";
            ...
            if ($res)
            {
                ...
                <section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                    <div class="container">
                        ...
                        <center><h2 style="color: white;font-size: 40px">Payment status is updated successfully.</h2>
                            <br><br><br><br>
                            <br><br><br>
                        </center>
                    </div><br><br>
        ...
        if ($category=='Repair')
        {
            @$q="update repair_bookings set website_pay_received='Yes' where id='$id'";
            @$res = mysqli_query($a, $q);
            if ($res)
            {
                ?>
        ...
        {
            @$q="update renovation_bookings set website_pay_received='Yes' where id='$id'";
            @$res = mysqli_query($a, $q);
            if ($res)
            {
                ?>
        ...
        if ($category=='Maid')
        {
            @$q="update maid_bookings set website_pay_received='Yes' where id='$id'";
            @$res = mysqli_query($a, $q);
            if ($res)
            {
                ?>
        ...
        {
            @$q="update movers_bookings set website_pay_received='Yes' where id='$id'";
            @$res = mysqli_query($a, $q);
            if ($res)
            {
                ?>
        ...
        if ($category=='Tuition')
        {
            @$q="update tuition_bookings set website_pay_received='Yes' where id='$id'";
            @$res = mysqli_query($a, $q);
            if ($res)
            {
                ?>
        ...
        {
            @$q="update photography_bookings set website_pay_received='Yes' where id='$id'";
            @$res = mysqli_query($a, $q);
            if ($res)
            {
                ?>
