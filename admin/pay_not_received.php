...
if(!isset($_SESSION["username"]))
{
    ...
    if ($city!=null)
    {
        if ($category=='Beauty')
        {
            @$q="SELECT * FROM beauty_bookings where service_city='$city' and website_pay_received='No'";
            ...
            if ($res)
            {
                ...
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Unpaid beauty service in <?php echo $city; ?> are..</h2>
                        </center>
                        <table class="container table table-striped">
                            ...
                            while ($row=mysqli_fetch_array($res))
                            {
                                ...
                                <tr class="row" style="background-color: lavender;color: #117a8b">
                                    ...
                                    <form action="pay_not_received_details.php" method="post">
                ...
                else
                {
                    ...
                    <section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                        ...
                        <div class="container">
                            <br><br><br><br><br>
                            <center><h2 style="color: white;font-size: 40px">No unpaid beauty service found in <?php echo $city; ?></h2>
                                <br><br><br>
        ...
        if ($category=='Repair')
        {
            @$q="SELECT * FROM repair_bookings where service_city='$city' and website_pay_received='No'";
            @$res = mysqli_query($a, $q);
            if ($res)
            {
                $rowcount=mysqli_num_rows($res);
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Unpaid repair service in <?php echo $city; ?> are..</h2>
                        </center>
                        <table class="container table table-striped">
                            <thead>
                            <tr class="bg-warning row">
                ...
                else
                {
                    ...
                    <section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                        ...
                        <div class="container">
                            <br><br><br><br><br>
                            <center><h2 style="color: white;font-size: 40px">No unpaid repair service found in <?php echo $city; ?></h2>
                                <br><br><br>
                                <h2 style="font-family: 'Brush Script MT'">Thank You...</h2>
                                <br><br><br>
                            </center>
        ...
        {
            @$q="SELECT * FROM renovation_bookings where service_city='$city' and website_pay_received='No'";
            @$res = mysqli_query($a, $q);
            if ($res)
            {
                $rowcount=mysqli_num_rows($res);
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Unpaid renovation service in <?php echo $city; ?> are..</h2>
                        </center>
                        <table class="container table table-striped">
                            <thead>
                            <tr class="bg-warning row">
                ...
                else
                {
                    ...
                    <section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                        ...
                        <div class="container">
                            <br><br><br><br><br>
                            <center><h2 style="color: white;font-size: 40px">No unpaid renovation service found in <?php echo $city; ?></h2>
                                <br><br><br>
                                <h2 style="font-family: 'Brush Script MT'">Thank You...</h2>
                                <br><br><br>
                            </center>
        ...
        if ($category=='Maid')
        {
            @$q="SELECT * FROM maid_bookings where service_city='$city' and website_pay_received='No'";
            @$res = mysqli_query($a, $q);
            if ($res)
            {
                $rowcount=mysqli_num_rows($res);
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Unpaid maid service in <?php echo $city; ?> are..</h2>
                        </center>
                        <table class="container table table-striped">
                            <thead>
                            <tr class="bg-warning row">
                ...
                else
                {
                    ...
                    <section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                        ...
                        <div class="container">
                            <br><br><br><br><br>
                            <center><h2 style="color: white;font-size: 40px">No unpaid maid service found in <?php echo $city; ?></h2>
                                <br><br><br>
                                <h2 style="font-family: 'Brush Script MT'">Thank You...</h2>
                                <br><br><br>
                            </center>
        ...
        {
            @$q="SELECT * FROM movers_bookings where origin='$city' and website_pay_received='No'";
            @$res = mysqli_query($a, $q);
            if ($res)
            {
                $rowcount=mysqli_num_rows($res);
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Unpaid packers & movers service in <?php echo $city; ?> are..</h2>
                        </center>
                        <table class="container table table-striped">
                            <thead>
                            <tr class="bg-warning row">
                ...
                else
                {
                    ...
                    <section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                        ...
                        <div class="container">
                            <br><br><br><br><br>
                            <center><h2 style="color: white;font-size: 40px">No unpaid packers & movers service found in <?php echo $city; ?></h2>
                                <br><br><br>
                                <h2 style="font-family: 'Brush Script MT'">Thank You...</h2>
                                <br><br><br>
                            </center>
        ...
        if ($category=='Tuition')
        {
            @$q="SELECT * FROM tuition_bookings where service_city='$city' and website_pay_received='No'";
            @$res = mysqli_query($a, $q);
            if ($res)
            {
                $rowcount=mysqli_num_rows($res);
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Unpaid tuition service in <?php echo $city; ?> are..</h2>
                        </center>
                        <table class="container table table-striped">
                            <thead>
                            <tr class="bg-warning row">
                ...
                else
                {
                    ...
                    <section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                        ...
                        <div class="container">
                            <br><br><br><br><br>
                            <center><h2 style="color: white;font-size: 40px">No unpaid tuition service found in <?php echo $city; ?></h2>
                                <br><br><br>
                                <h2 style="font-family: 'Brush Script MT'">Thank You...</h2>
                                <br><br><br>
                            </center>
        ...
        {
            @$q="SELECT * FROM photography_bookings where service_city='$city' and website_pay_received='No'";
            @$res = mysqli_query($a, $q);
            if ($res)
            {
                $rowcount=mysqli_num_rows($res);
                if ($rowcount!=0)
                {
                    ...
                    <section class="features tb bb" id="features" >
                        ...
                        <center><h2 style="font-size: 35px;" class="mb-4 text-light">Unpaid photography service in <?php echo $city; ?> are..</h2>
                        </center>
                        <table class="container table table-striped">
                            <thead>
                            <tr class="bg-warning row">
                ...
                else
                {
                    ...
                    <section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                        ...
                        <div class="container">
                            <br><br><br><br><br>
                            <center><h2 style="color: white;font-size: 40px">No unpaid photography service found in <?php echo $city; ?></h2>
                                <br><br><br>
                                <h2 style="font-family: 'Brush Script MT'">Thank You...</h2>
                                <br><br><br>
                            </center>
