...
<div class="container">
			...
			<img src="../img/adm.png" class="user1">
                      <center><h3 class="text-white">Password Recovery</h3></center><br>
			<form action="a_pass_recovery.php" method="post">
				<input type="text" name="username" placeholder="Enter Admin Username" required>

                <input type="text" value="What is the motto of Mahika?" readonly>
