...
@$query="update worker_details set verification='Rejected' where username='$dbusername'";
...
<section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
    <div class="container">
        ...
        <center><h2 style="color: white;font-size: 40px">The worker's verification is rejected.</h2>
            <br><br><br><br>
            <br><br><br>
        </center>
    </div><br><br>
