...
if(!isset($_SESSION["username"]))
{
    ...
    if ($name!=null)
    {
        ...
        <section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
            <form action="pending_workers.php" method="post">
                    ...
                    <div class="col-sm-12 col-md-12 my-auto">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <form action="w_confirm_update.php" method="post">
                                        <input type="hidden" name="dbusername" value="<?php echo $dbusername; ?>">
                                        <input class="btn" style="background-color: green;color: white;padding: 10px" type="submit" name="" value="Confirm Worker?">
                                    </form><br>
                                    <form action="w_reject_update.php" method="post">
                                        <input type="hidden" name="dbusername" value="<?php echo $dbusername; ?>">
                                        <input class="btn" style="background-color: red;color: white;padding: 10px" type="submit" name="" value="Reject worker?">
                                    </form>
                                </div>
                            </div>
                        </div>
