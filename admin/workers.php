...
if(!isset($_SESSION["username"]))
{
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger hvr-glow " href="#">Workers</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="features" id="features" style="background: url('../img/1577733.jpg') center center/cover no-repeat;">
        <div class="container">
            <div style="text-align: center;margin-top: 60px;">
                <h1 class="mb-5 text-dark" style="font-size: 50px;">Worker Record</h1>
            </div>
            <div class="row">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <div class="feature-item" style="border-radius: 10px;background:-webkit-gradient(linear, left top, right top, from(#1da1f2), to(#dee2e6))">
                                    <a href="pending_workers.php">
                                        <i><img class="hvr-bounce-in" src="../img/pndng.png"></i>
                                        <br>
                                        <h3 style="color: #3b5998;margin-top: 8px;">Pending verification</h3>
                                    </a>
                            ...
                            <div class="col-sm-3">
                                <div class="feature-item" style="border-radius:10px;background:-webkit-gradient(linear, left top, right top, from(#1da1f2), to(#dee2e6))">
                                    <a href="confirmed_workers.php">
                                        <i><img class="hvr-bounce-in" src="../img/mini_sfg.png"></i>
                                        <br>
                                        <h3 style="color: #3b5998;margin-top: 8px;">Confirmed verification</h3>
                            ...
                            <div class="col-sm-3">
                                <div class="feature-item" style="border-radius:10px;background:-webkit-gradient(linear, left top, right top, from(#1da1f2), to(#dee2e6))">
                                    <a href="rejected_workers.php">
                                        <i><img class="hvr-bounce-in" src="../img/mini_close_redhhh.png"></i>
                                        <br>
                                        <h3 style="color: #3b5998;margin-top: 8px;">Rejected verification</h3>
