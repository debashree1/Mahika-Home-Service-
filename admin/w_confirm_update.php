...
@$query="update worker_details set verification='Confirmed' where username='$dbusername'";
...
<section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
    <div class="container">
        ...
        <center><h2 style="color: white;font-size: 40px">The worker's verification is confirmed.</h2>
            <br><br><br><br>
            <br><br><br>
        </center>
    </div><br><br>
