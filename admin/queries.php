    ...
    if ($res)
    {
        ...
        if ($rowcount!=0)
        {
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link js-scroll-trigger hvr-glow " href="#">Queries</a>
                            </li>
                            <li class="nav-item">
            ...
            <section class="features tb bb" id="features" >
                <br><br>
                <center><h2 style="font-size: 35px;" class="mb-4 text-light">Queries & feedback regarding Mahika Home Service are...</h2>
                </center>
                <table class="container table table-striped">
                    <thead>
                    <tr class="bg-warning row">
                        <th scope="col" class="col-sm-1" style="text-align: center">#</th>
                        <th scope="col" class="col-sm-1" style="text-align: center">Name</th>
                        <th scope="col" class="col-sm-2" style="text-align: center">Email</th>
                        <th scope="col" class="col-sm-2" style="text-align: center">Phone</th>
                        <th scope="col" class="col-sm-2" style="text-align: center">Address</th>
                        <th scope="col" class="col-sm-4" style="text-align: center">Query</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    while ($row=mysqli_fetch_array($res))
                    {
                        ...
                        <tr class="row" style="background-color: lavender;color: #117a8b">
                            ...
                            <td class="col-sm-1" style="text-align: center"><?php echo $dbname; ?></td>
                            <td class="col-sm-2" style="text-align: center"><?php echo $dbemail; ?></td>
                            <td class="col-sm-2" style="text-align: center"><?php echo $dbphone; ?></td>
                            <td class="col-sm-2" style="text-align: center"><?php echo $dbaddress; ?></td>
                            <td class="col-sm-4" style="text-align: center"><?php echo $dbmessage; ?></td>
                        </tr>
                        <?php
                        $i=$i+1;
                    }
        ...
        else
        {
            ...
            <section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                <div class="container">
                    <br><br><br><br><br>
                    <center><h2 style="color: white;font-size: 40px">Mahika doesn't have any queries.</h2>
                        <br><br><br>
