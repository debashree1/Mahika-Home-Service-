...
if(!isset($_SESSION["username"]))
{
    ...
    @$q="SELECT * FROM worker_details where verification='Pending'";
    ...
    if ($res)
    {
        ...
        if ($rowcount!=0)
        {
            ...
            <section class="features tb bb" id="features" >
                ...
                <br><br>
                <center><h2 style="font-size: 35px;" class="mb-4 text-light">Workers with pending verification are...</h2>
                </center>
                <table class="container table table-striped">
                    ...
                    while ($row=mysqli_fetch_array($res))
                    {
                        ...
                        <tr class="row" style="background-color: lavender;color: #117a8b">
                            ...
                            <form action="pending_w_details.php" method="post">
        ...
        else
        {
            ...
            <section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                <div class="container">
                    ...
                    <center><h2 style="color: white;font-size: 40px">Mahika doesn't have any pending worker.</h2>
                        <br><br><br>
