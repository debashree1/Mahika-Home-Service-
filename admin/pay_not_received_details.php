    ...
    if ($category!=null)
    {
        if ($category=='Beauty')
        {
            ...
            <section class="features" id="features" style="background: url(../img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                <form action="pay_not_received.php" method="post">
                                    ...
                                    <div class="col-md-4">
                                        <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius:10px;background: rgba(0,0,0,.6);">
                                            <div class="loginBox2">
                                                ...
                                                {
                                                    ?><br>
                                                    <form action="pay_received_update.php" method="post">
                                                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                                                        <input type="hidden" name="category" value="<?php echo $category; ?>">
                                                        <input class="btn" style="background-color: yellow;color: black" type="submit" name="" value="Pay Received?">
                                                    </form>
                                                    <?php
                                                }
                                                ?>
