                    ...
                    if($result)
                    {
                        ...
                        if ($rowcount!=0)
                        {
                            ...
                            <table class="container table table-striped">
                                ...
                                while ($row=mysqli_fetch_array($result))
                                {
                                    ...
                                    <tr class="row" style="background-color: lavender;color: #117a8b">
                                        ...
                                        <td class="col-2"><?php echo "Rs. ".$dbrate."/day"; ?></td>
                                        <form action="maid_cost.php" method="post">
                                            <input type="hidden" name="payment" value="<?php echo $dbpayment; ?>">
                            ...
                            <center><h3 class="mb-4 text-light">Would you like to search within your 5km radius?</h3>
                                <form action="find_service3_maid.php" method="post">
