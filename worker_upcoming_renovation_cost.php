                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius: 10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    <center><h3 class="text-white">Renovation Service Details</h3><br></center>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius: 10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    {
                                                        ?>
                                                        <form action="worker_renovation_start.php" method="post"><br>
                                        ...
                                        <div class="col-md-4">
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius:10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    <form action="worker_renovation_cancellation.php" method="post">
                                                        ...
                                                        ?>
                                                        <p style="border-bottom:2px solid deeppink ;color: #f1b0b7;;border-bottom: 2px solid deeppink">Your Rate : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$worker_rate." / service"; ?></b></p>
