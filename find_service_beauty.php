                ...
                <div class="card-body">
                    <ul class="tab-list">
                        ...
                        <li class="tab-list__item active">
                            <a class="tab-list__link" href="#tab3" data-toggle="tab">Beauty</a>
                        </li>
                        <li class="tab-list__item">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab3">
                            <form method="POST" action="find_service2_beauty.php">
                                <div class="input-group">
                                    <label class="label">Select Beauty Service:</label>
                                    <i class="zmdi zmdi-face input-group-symbol"></i>
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="service" required="required" class="form-control">
                                            <option value="" selected disabled>--Select--</option>
                                            <option value="Hairstyle & Make Up">Hairstyle & Make Up</option>
                                            <option value="Hair Cut">Hair Cut</option>
                                            <option value="Hair Straightening">Hair Straightening</option>
                                            <option value="Spa">Spa</option>
                                            <option value="Massage for man">Massage for man</option>
                                            <option value="Massage for woman">Massage for woman</option>
