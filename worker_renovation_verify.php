...
if(!isset($_SESSION["username"]))
{
    ...
    @$query="select code from renovation_bookings where id='$id'";
    ...
    if ($id!=null)
    {
        if ($result)
        {
            ...
            <section class="features" id="features" style="background: url(img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);"><br><br>
                <div class="container">
                    <center><h2 style="font-family: 'Bradley Hand ITC';font-weight: bold;color: yellow">Enter the security code that is sent to the customer.</h2></center><br>
