...
if(!isset($_SESSION["username"]))
{
    ...
    if ($category!=null)
    {
        if($res)
        {
            ...
            <section class="features tb bb" id="features" >
                <form action="find_service_renovation.php" method="post">
                ...
                while ($row=mysqli_fetch_array($res))
                {
                    ...
                    @$query="SELECT * FROM worker_details where category='$category' and subarea='$dbarea' and (service1='$service' or service2='$service')";
                    ...
                    if($result)
                    {
                        ...
                        {
                            ?><br><br>
                            <center><h2 style="font-size: 35px;" class="mb-4 text-light">The following <?php echo $service; ?> professionals are found in your area</h2>
                            </center>
                            <table class="container table table-striped">
                                ...
                                while ($row=mysqli_fetch_array($result))
                                {
                                    ...
                                    <tr class="row" style="background-color: lavender;color: #117a8b">
                                        ...
                                        <td class="col-2"><?php echo $dbname; ?></td>
                                        <td class="col-2"><?php echo $dbbasis; ?></td>
                                        <td class="col-2"><?php echo $dbarea; ?></td>
                                        <td class="col-2"><?php echo "Rs. ".$dbrate." for ".$house; ?></td>
                                        <form action="renovation_cost.php" method="post">
                            ...
                            <br>
                            <center><h3 class="mb-4 text-light">Would you like to search within your 5km radius?</h3>
                                <form action="find_service3_renovation.php" method="post">
                                    <input type="hidden" name="payment" value="<?php echo $payment; ?>">
                                    <input type="hidden" name="u_card_no" value="<?php echo $dbu_card_no; ?>">
                                    <input type="hidden" name="area" value="<?php echo $dbarea; ?>">
                                    <input type="hidden" name="address" value="<?php echo $address; ?>">
                                    ...
                                    <input type="hidden" name="dbarea" value="<?php echo $dbarea; ?>">
                                    <input type="hidden" name="category" value="<?php echo $category; ?>">
                                    <input type="hidden" name="service" value="<?php echo $service; ?>">
                                    <input type="hidden" name="house" value="<?php echo $house; ?>">
                                    <input type="hidden" name="from" value="<?php echo $from; ?>">
                                    <input type="hidden" name="time" value="<?php echo $time; ?>">
                                    <center><input type="submit" class="cont_button1 btn-info" value="Search"></center>
                                </form><br><br>
                        ...
                        else
                        {
                            ...
                            <br><br><br><br><br>
                            <div><br>
                                <h1 style="font-size: 40px" class="mb-4 text-light">Oops.. No <?php echo $service; ?> professional found in your area</h1>
                                <center><h3 class="mb-4 text-light">Would you like to search within 5km radius?</h3>
                                    <div class="container1">
                                        <form action="find_service3_renovation.php" method="post">
                                            ...
                                            <input type="hidden" name="from" value="<?php echo $from; ?>">
                                            <input type="hidden" name="time" value="<?php echo $time; ?>">
                                            <input id="contact_btn" type="submit" class="contact_button trans_100" style="float: right;" value="Search">
                                        </form>
                                    </div>
                                </center>
                            </div>
    ...
    {
        header("Location:find_service_renovation.php");
    }
}
?>