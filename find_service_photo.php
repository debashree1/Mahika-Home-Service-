                ...
                <div class="card-body">
                    <ul class="tab-list">
                        ...
                        <li class="tab-list__item active">
                            <a class="tab-list__link" href="#tab6" data-toggle="tab">Photography</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab6">
                            <form method="POST" action="find_service2_photo.php">
                                <div class="input-group">
                                    <label class="label">Select Photography:</label>
                                    <i class="zmdi zmdi-camera input-group-symbol"></i>
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="service" required="required" class="form-control">
                                            <option value="" selected disabled>--Select--</option>
                                            <option value="Personal Photography">Personal</option>
                                            <option value="Business Photography">Business</option>
                                            <option value="Wedding Photography">Wedding</option>
                                            <option value="Festival Photography">Festival</option>
                                        </select>
