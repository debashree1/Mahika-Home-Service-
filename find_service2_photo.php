...
if(!isset($_SESSION["username"]))
{
    ...
    if ($category!=null)
    {
        if($res)
        {
            ...
            <section class="features tb bb" id="features" >
                <form action="find_service_photo.php" method="post">
                    ...
                    if($result)
                    {
                        ...
                        if ($rowcount!=0)
                        {
                            ...
                            <table class="container table table-striped">
                                ...
                                while ($row=mysqli_fetch_array($result))
                                {
                                    ...
                                    <tr class="row" style="background-color: lavender;color: #117a8b">
                                        ...
                                        <form action="photo_cost.php" method="post">
                            ...
                            <center><h3 class="mb-4 text-light">Would you like to search within your 5km radius?</h3>
                                <form action="find_service3_photo.php" method="post">
    ...
    {
        header("Location:find_service_photo.php");
    }
}
?>