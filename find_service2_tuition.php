...
if(!isset($_SESSION["username"]))
{
                    ...
                    if($result)
                    {
                        ...
                        if ($rowcount!=0)
                        {
                            ...
                            <table class="container table table-striped">
                                ...
                                while ($row=mysqli_fetch_array($result))
                                {
                                    ...
                                    <tr class="row" style="background-color: lavender;color: #117a8b">
                                        ...
                                        <td class="col-2"><?php echo "Rs. ".$dbrate."/month"; ?></td>
                                        <form action="tuition_cost.php" method="post">
                                            ...
                                            <input type="hidden" name="sub" value="<?php echo $dbarea; ?>">
                            ...
                            <center><h3 class="mb-4 text-light">Would you like to search within your 5km radius?</h3>
                                <form action="find_service3_tuition.php" method="post">
                                    <input type="hidden" name="payment" value="<?php echo $payment; ?>">
                                    <input type="hidden" name="address" value="<?php echo $address; ?>">
                                    <input type="hidden" name="u_card_no" value="<?php echo $dbu_card_no; ?>">
                                    <input type="hidden" name="pin" value="<?php echo $pin; ?>">
                        ...
                        else
                        {
                            ...
                            <br><br><br><br><br>
                            <div><br>
                                <h1 style="font-size: 40px" class="mb-4 text-light">Oops.. No <?php echo $service; ?> tutor found in your area</h1>
    ...
    {
        header("Location:find_service_tuition.php");
    }
}
?>