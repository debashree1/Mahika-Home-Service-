...
else
{
    ...
    if ($w_name!=null)
    {
        ...
        <section class="features" id="features" style="background: url(img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
            <form action="find_service2_movers.php" method="post">
                                    ...
                                    <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius: 10px;background: rgba(0,0,0,.6);">
                                        <div class="loginBox2">
                                            ...
                                            <form action="find_service_movers.php" method="post">
                                                ...
                                                <p style="color: #f1b0b7;">Destination : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo $destination; ?></b></p><br>
                                ...
                                <div class="col-md-4">
                                    <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius:10px;background: rgba(0,0,0,.6);">
                                        <div class="loginBox2">
                                            ...
                                            <form action="confirm_movers.php" method="post">
                                                ...
                                                <p style="color: #f1b0b7;border-bottom: 2px solid deeppink">Rate : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif';"><?php echo "Rs. ".$rate." for ".$destination; ?></b></p>
