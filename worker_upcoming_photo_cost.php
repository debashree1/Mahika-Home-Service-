...
else
{
    ...
    @$query="select booking_request from photography_bookings where id='$id'";
                            ...
                            <div class="col-sm-12 col-md-12 my-auto">
                                <div class="container-fluid">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius: 10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    <center><h3 class="text-white">Photography Service Details</h3><br></center>
                                                    <p style="color: #f1b0b7;">Service : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo $service; ?></b></p>
                                                    <p style="color: #f1b0b7;">Date : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo $from_date; ?></b></p>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius: 10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    {
                                                        ?>
                                                        <form action="worker_photo_start.php" method="post"><br>
                                        ...
                                        <div class="col-md-4">
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius:10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    <form action="worker_photo_cancellation.php" method="post">
                                                        ...
                                                        ?>
                                                        <p style="color: #f1b0b7;;border-bottom: 2px solid deeppink">Your Rate : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$worker_rate." / service"; ?></b></p>
                                                        <p style="color: #f1b0b7;">Charge : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$charge; ?></b></p>
                                                        <p style="border-bottom: 2px solid deeppink;color: #f1b0b7;">Transport : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$transport_charge; ?></b></p>
                                    ...
                                    <center style="color: lightgrey"><br>
                                        ...
                                        <br><h3>If you do not belong to service area, Rs.15 will be given as transportation fee. See above payment info.</h3>
                                    </center>
                </section>
                <!-- Jquery JS-->
