                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius: 10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    <center><h3 class="text-white">Repair Service Details</h3><br></center>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius: 10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    {
                                                        ?>
                                                        <form action="worker_repair_start.php" method="post"><br>
                                        ...
                                        <div class="col-md-4">
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius:10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    <form action="worker_repair_cancellation.php" method="post">
