                ...
                <div class="card-body">
                    <ul class="tab-list">
                        <li class="tab-list__item">
                            <a class="tab-list__link" href="find_service.php">Maid</a>
                        </li>
                        <li class="tab-list__item">
                        ...
                        <li class="tab-list__item active">
                            <a class="tab-list__link" href="#tab5" data-toggle="tab">Movers</a>
                        </li>
                        <li class="tab-list__item">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab5">
                            <form method="POST" action="find_service2_movers.php">
                                <div class="input-group">
                                    <label class="label">Select Packers & Movers:</label>
                                    <i class="zmdi zmdi-truck input-group-symbol"></i>
                                ...
                                <div class="row row-space">
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <i class="zmdi zmdi-my-location input-group-symbol"></i>
                                            <div class="rs-select2 js-select-simple select--no-search">
                                                <select name="origin" required="required" class="form-control">
                                                    <option value="" selected disabled>--Select--</option>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <div class="rs-select2 js-select-simple select--no-search">
                                                <select name="destination" required="required" class="form-control">
                                                    <option value="" selected disabled>--Select--</option>
                                                    <option value="Within City">Within City</option>
                                                    <option value="100-200km">Within 200km</option>
                                                    <option value="200-400km">Within 400km</option>
                                                    <option value="400-600km">Within 600km</option>
                                                    <option value="600-800km">Within 800km</option>
                                                </select>
                                                <div class="select-dropdown"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="row row-space">
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <label class="label" style="margin-bottom: 10px;margin-top: 5px;">Select Date</label>
                                ...
                                <input type="hidden" name="category" value="Packers & Movers">
