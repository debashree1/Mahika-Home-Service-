...
if ($_SESSION["username"]==true)
{
    ...
    if($result)
    {
        ...
        {
            $q="insert into worker_details(basis, name , email,   city  ,  subarea   , address, pin, username  ,  phone ,  password  ,  question ,   answer , category, doc, doc_no, experience) values('$basis','$name','$email','$city','$area','$address','$pin','$username','$phone','$password','$question','$answer','$category','$doc','$doc_no','$experience')";
