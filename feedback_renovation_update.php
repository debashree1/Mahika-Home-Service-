...
else
{
    ...
    if($id!=null)
    {
        @$q="update renovation_bookings set complain_registered='No',feedback='$complain' where id='$id'";
        @$r = mysqli_query($a, $q);
        if ($r)
        {
            ?>
            ...
            <section class="features tb bb" id="features" >
                ...
                <br><br><br>
                <center><h3 style="font-size: 40px" class="text-light">Thank you. Your feedback is appreciated</h3>
                    <br><br>
                    <h3 class="text-light">We are working tirelessly to improve our service.</h3>
                    <br><br>
                    <h3 class="text-warning">With regards, Mahika Home Service Team.</h3>
                </center>
                <br><br>
                <br><br><br>
            </section>
