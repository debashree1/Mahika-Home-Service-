...
else
{
    ...
    @$query="select booking_request from maid_bookings where id='$id'";
        ...
        if ($booking_request=="Pending")
        {
            if ($service_area!=null)
            {
                ...
                <section class="features" id="features" style="background: url(img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
                    <form action="worker_upcoming.php" method="post">
                            ...
                            <div class="col-sm-12 col-md-12 my-auto">
                                <div class="container-fluid">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius: 10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    <center><h3 class="text-white">Maid Service Details</h3><br></center>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius: 10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    {
                                                        ?>
                                                        <form action="worker_maid_start.php" method="post"><br>
                                                            <input type="hidden" name="id" value="<?php echo $id; ?>">
                                                            <input type="hidden" name="booking_request" value="Pending">
                                                            <input class="btn" style="background-color: deeppink;color: white" type="submit" name="" value="Start Work">
                                                        </form>
                                                        <?php
                                                    }
                                                    ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="feature-item" style="text-align:left;padding-left:15px;padding-right:15px;margin-top: 10px;border-radius:10px;background: rgba(0,0,0,.6);">
                                                <div class="loginBox2">
                                                    ...
                                                    <form action="worker_maid_cancellation.php" method="post">
                                                        ...
                                                        ?>
                                                        <p style="color: #f1b0b7;;border-bottom: 2px solid deeppink">Your Rate : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$worker_rate." / day"; ?></b></p>
                                                        <p style="color: #f1b0b7;">Charge : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$worker_rate." * ".$days." = Rs. ".$charge; ?></b></p>
                                                        ...
                                                        <p style="color: #f1b0b7;border-bottom: 2px solid deeppink">Extra time : <b style="color: white;font-family: 'Muli', 'Helvetica', 'Arial', 'sans-serif'"><?php echo "Rs. ".$extra_charge." * ".$days." = Rs. ".$extra; ?></b></p>
                                                        ...
                                                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                                                        <input type="hidden" name="booking_request" value="Pending">
                                                        <input class="btn" style="background-color: red;color: white" type="submit" name="" value="Cancel Booking">
                                                    </form>
                                                </div>
                                            </div>
                                    ...
                                    <center style="color: lightgrey"><br>
                                        ...
                                        <br><h3>If you do not belong to service area, Rs.15/day will be given as transportation fee.</h3>
                                        <br><h3>Again, max 3hours work does not cost extra charge. For extra time work, Rs.50/hour will be given. See above payment details.</h3>
                                    </center>
                </section>
                <!-- Jquery JS-->
