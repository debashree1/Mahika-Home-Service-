...
else
{
    ...
    <section class="features" id="features" style="background: url(img/bg-pattern.png), -webkit-linear-gradient(left, #6f42c1, #e4606d);">
        ...
        <div class="container">
            <center><b style="color: white;font-size: 50px;font-family: 'Bradley Hand ITC'">Finished Service Record</b><br>
                <p style="color: yellow;font-size: 30px">Please select a category from the following...</p><br>
                <div class="row">
                    <div class="col-md-4"></div>
                    <a href="user_maid_finished.php" class="col-12 col-md-4 btn hvr-bob" style="color: black;width: 100px;height: 100px;margin-bottom: 10px;background-color: sandybrown;padding-top: 35px">
                        Maid Service
                    </a>
                    <div class="col-md-4"></div>
                    <a href="user_beauty_finished.php" class="col-12 col-md-4 btn hvr-bob" style="color: black;width: 100px;height: 100px;margin-bottom: 10px;background-color: lightpink;padding-top: 35px">
                        Beauty Service
                    </a>
                    <a href="user_renovation_finished.php" class="col-12 col-md-4 btn hvr-bob" style="color: black;width: 100px;height: 100px;margin-bottom: 10px;background-color: lavender;padding-top: 35px">
                        Renovation Service
                    </a>
                    <a href="user_repair_finished.php" class="col-12 col-md-4 btn hvr-bob" style="color: black;width: 100px;height: 100px;margin-bottom: 10px;background-color: wheat;padding-top: 35px">
                        Repair Service
                    </a>

                    <a href="user_movers_finished.php" class="col-12 col-md-4 btn hvr-bob" style="color: black;width: 100px;height: 100px;margin-bottom: 10px;background-color:#1da1f2;padding-top: 35px">
                        Packers & Movers Service
                    </a>
                    <a href="user_tuition_finished.php" class="col-12 col-md-4 btn hvr-bob" style="color: black;width: 100px;height: 100px;margin-bottom: 10px;background-color: greenyellow;padding-top: 35px">
                        Tuition Service
                    </a>
                    <a href="user_photo_finished.php" class="col-12 col-md-4 btn hvr-bob" style="color: black;width: 100px;height: 100px;margin-bottom: 10px;background-color: mediumpurple;padding-top: 35px">
                        Photography Service
                    </a>
