...
else
{
    ...
    if($id!=null)
    {
        @$q="update movers_bookings set complain_registered='Yes',feedback='$complain' where id='$id'";
        @$r = mysqli_query($a, $q);
        if ($r)
        {
            ?>
            ...
            <section class="features tb bb" id="features" >
                <form action="user_movers_ongoing.php" method="post">
    ...
    {
        header("Location:user_movers_ongoing.php");
    }
}
?>
